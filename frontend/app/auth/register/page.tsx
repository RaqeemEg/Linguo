...
import { ArrowLeft, Eye, EyeOff, Shield, Zap, CheckCircle } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex">
          ...
          <Card className="border-2 shadow-2xl">
            <CardHeader className="text-center pb-8">
              ...
              <CardDescription className="text-lg mt-2">
                Join Linguo and start breaking communication barriers today
              </CardDescription>
            </CardHeader>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/5 to-primary/10 items-center justify-center p-8">
        <div className="max-w-md text-center">
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-foreground mb-4">Start your journey to inclusive communication</h2>
            <p className="text-lg text-muted-foreground">
              Join thousands who are already experiencing barrier-free conversations
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-4 p-4 rounded-xl bg-background/50 backdrop-blur">
              ...
              <div className="text-left">
                <p className="font-semibold text-foreground">Free 14-day trial</p>
            ...
            <div className="flex items-center space-x-4 p-4 rounded-xl bg-background/50 backdrop-blur">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-muted-foreground">Start translating in under 2 minutes</p>
              </div>
            </div>
          ...
          <div className="mt-8 space-y-4">
            <Badge variant="secondary" className="px-4 py-2">
              🎉 Join 10,000+ satisfied users worldwide
            </Badge>
